...
file_put_contents('temp/'.$moduleName.'/'.$moduleName.'.xml', $dom->saveXML());
  ...
  $enGBModIni .= "{$moduleNameUpperCase}_JFIELD_PREPARE_CONTENT_DESC=\"Choose if you want to prepare the content for plugins\"".PHP_EOL;
  ...
  $ptBRModIni .= "{$moduleNameUpperCase}_JFIELD_PREPARE_CONTENT_DESC=\"Escolha se deseja preparar o conteúdo para plugins\"".PHP_EOL;
  $ptBRModIni .= "{$moduleNameUpperCase}_JFIELD_BACKGROUNDIMAGE_LABEL=\"Imagem de Fundo\"".PHP_EOL;
  $ptBRModIni .= "{$moduleNameUpperCase}_JFIELD_BACKGROUNDIMAGE_DESC=\"Selecione uma imagem para usar como fundo\"".PHP_EOL;
  // add {$moduleNameUpperCase}_CUSTOM_LABEL and {$moduleNameUpperCase}_CUSTOM_DESC
...
$zip = new ZipArchive();
$zip->open("temp/{$moduleName}-J{$joomlaVersion}-{$moduleClient}-V{$moduleVersion}.zip", ZipArchive::CREATE | ZipArchive::OVERWRITE);
if ($joomlaVersion == 3) {
...
<div class="alert alert-success" role="alert">
  ...
  // "Módulo %1s versão %2s para Joomla %3s gerado com sucesso!"
   echo sprintf($translations['MODULE_GENERATED'], '<strong>'.$moduleTitle.'</strong>', $moduleVersion, $joomlaVersion); ?></h2>

  <p><a class="btn btn-success" href="<?php echo 'temp/'.$moduleName.'-J'.$joomlaVersion.'-'.$moduleClient.'-V'.$moduleVersion.'.zip'; ?>" role="button"><?php echo $translations['DOWNLOAD_MODULE']; ?></a></p>
</div>
<?php endif; ?>
  </header>
  <main>
...
<!-- Joomla Version -->
<label for="joomla_version" class="form-label"><?php echo $translations['JOOMLA_VERSION']; ?></label>
<select class="form-select" id="joomla_version" name="joomla_version" required>
  <option value="3">3</option>
  <option value="4">4</option>
</select>
<label for="module_title" class="form-label"><?php echo $translations['MODULE_TITLE']; ?></label>
<input type="text" class="form-control" id="module_title" name="module_title" required placeholder="<?php echo $translations['MODULE_TITLE_PLACEHOLDER']; ?>">
  </div>
  <div class="mb-3">
<label for="module_description" class="form-label"><?php echo $translations['MODULE_DESCRIPTION']; ?></label>
<textarea class="form-control" id="module_description" name="module_description" rows="3" required placeholder="<?php echo $translations['MODULE_DESCRIPTION_PLACEHOLDER']; ?>"></textarea>
  </div>
  <div class="mb-3">
<label for="module_version" class="form-label"><?php echo $translations['MODULE_VERSION']; ?></label>
<input type="text" class="form-control" id="module_version" name="module_version" required placeholder="<?php echo $translations['MODULE_VERSION_PLACEHOLDER']; ?>">
  </div>
  <!-- license -->
  <div class="mb-3">
<label for="module_license" class="form-label"><?php echo $translations['MODULE_LICENSE']; ?></label>
...
<option value="Other">Other</option>
  ...
  <!-- author -->
  <div class="mb-3">
<label for="module_author" class="form-label"><?php echo $translations['MODULE_AUTHOR']; ?></label>
<input type="text" class="form-control" id="module_author" name="module_author" required placeholder="<?php echo $translations['MODULE_AUTHOR_PLACEHOLDER']; ?>">
  </div>
  <!-- authorEmail -->
  <div class="mb-3">
<label for="module_author_email" class="form-label"><?php echo $translations['MODULE_AUTHOR_EMAIL']; ?></label>
<input type="text" class="form-control" id="module_author_email" name="module_author_email" required placeholder="<?php echo $translations['MODULE_AUTHOR_EMAIL_PLACEHOLDER']; ?>">
  </div>
  <!-- authorUrl -->
  <div class="module_author_url" class="form-label"><?php echo $translations['MODULE_AUTHOR_URL']; ?></label>
<input type="text" class="form-control" id="module_author_url" name="module_author_url" required placeholder="<?php echo $translations['MODULE_AUTHOR_URL_PLACEHOLDER']; ?>">
  </div>
  <button type="submit" class="btn btn-primary my-3"><?php echo $translations['GENERATE_MODULE']; ?></button>
  </div>
</div>
  </div>
</div>
